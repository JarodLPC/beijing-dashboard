...
let fetchOee = async () => {
    ...
    try {
        if (!Mock) {
            ...
            oeeData = [55.99, 99.99, 99.99, 66.99, 99.99, 99.99, 55.99, 99.99, 99.99, 99.99, 99.99, 99.99, 99.99, 99.99, 99.99, 99.99, 99.99, 99.99, 99.99, 99.99, 99.99, 99.99, 99.99,];
            optionOee.series[0].data = oeeData;
        }
...
let fetchMachineStopSummary = async () => {
    ...
    try {
        if (!Mock) {
            ...
            optionMachineStopSummary.xAxis.data = ['Failures', 'Production Stops', 'Set Up', 'Unplanned Stops', 'Speed Losses', 'Undefined', 'Failures', 'Production Stops', 'Set Up', 'Unplanned Stops', 'Speed Losses', 'Undefined']
            optionMachineStopSummary.series[0].data = [50, 10, 70, 0, 17, 0, 59, 0, 78, 0, 7, 0];
            optionMachineStopSummary.series[1].data = [0, 0, 4, 30, 0, 50, 0, 0, 47, 0, 77, 0];
        }
    ...
    series: [
        {
            name: 'duration',
            type: 'bar',
            data: [132.5, 119, 64.2, 54.6, 4.5, 1.3],
            itemStyle: {
                color: {
                    type: 'linear',
                    x: 0,
                    ...
                    colorStops: [
                        ...
                        { offset: 1, color: 'rgba(103, 224, 227, 0.8)' }
                    ]
                }
            }
        },
        {
            ...
            data: [35.2, 66.87, 83.94, 98.46, 99.65, 100]
        }
    ]
})
    ...
    <div style="flex: 0 1 50%">
        <dv-border-box12 style="width: 100%; height: 350px;">
            ...
            <div dv-bg v-else style="width:100%;height:100%">
                <Echarts :option="optionMachineStopSummary" style="width:100%;height:350px;" />
            </div>
        </dv-border-box12>
    </div>
    <div style="flex: 0 1 50%">
        <dv-border-box12 style="width: 100%; height: 350px;">
            ...
            <div dv-bg v-else style="width:100%;height:100%">
                <Echarts :option="optionOee" style="width:100%;height:350px;" />
            </div>
        </dv-border-box12>
